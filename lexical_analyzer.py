...
def read_user_code():
    print("Digite o código fonte (termine com uma linha vazia):")
    lines = []
    while True:
        line = input()
        if line == "":
...
def read_user_code():
    print("Olá! Digite o código fonte (termine com uma linha vazia):")
    lines = []
    while True:
        line = input()
        if line == "":
...
def menu():
    while True:
        ...
        print("\nMenu:")
        print("[1] - Colocar nova linha de código fonte")
        print("[2] - Sair")
